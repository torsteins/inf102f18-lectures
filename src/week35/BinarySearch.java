...
public class BinarySearch {
    ...
    /**
     * Finds the first index of the array containing an element which matches the key,
     * or returns -1 if no element was found. The array must already be sorted.
     *
    ...
    /**
     * Finds the last index of the array containing an element which matches the key,
     * or returns -1 if no element was found. The array must already be sorted.
     *
     * @param key the key to be searched for
     * @param arr the array to search
